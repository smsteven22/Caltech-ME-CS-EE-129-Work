...
def line_following(drive, sensor):
    ...
    while True:
        ...
        # print("Side output: ", side_output)
        # print("End of street level: ", end_of_street_level)
        # print("End of street:", end_of_street_output)

        # Stop line following if at an intersection or end of street
        if intersection_output == 1:
            # print("intersection_level: ", intersection_level)
            return Position.INTERSECTION
        elif end_of_street_output == 1 and side_output == 0:
            # print("end_of_street_level: ", end_of_street_level)
            # print("intersection_level: ", intersection_level)
...
def turning(drive, sensor, direction):
    ...
    # # Sleep robot for 150ms after turn
    # t0 = time.time()
    # t = t0
    # while t - t0 < T_STOP:
    #     t = time.time()
